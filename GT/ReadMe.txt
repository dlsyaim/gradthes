================================================================================
    MICROSOFT 基础类库: GT 项目概述
===============================================================================

应用程序向导已为您创建此 GT 应用程序。此应用程序不仅演示使用 Microsoft 基础类的基本知识，而且可作为编写应用程序的起点。

此文件包含组成 GT 应用程序的各个文件的内容摘要。
...
GT.h
    这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CGTApp 应用程序类。

GT.cpp
    这是包含应用程序类 CGTApp 的主要应用程序源文件。

GT.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\GT.ico
    这是用作应用程序图标的图标文件。此图标包括在主要资源文件 GT.rc 中。
...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏是在 CMainFrame 类中构造的。使用资源编辑器编辑此工具栏位图，并更新 GT.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一个文档类型和一个视图:

GTDoc.h，GTDoc.cpp - 文档
    这些文件包含 CGTDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CGTDoc::Serialize)。

GTView.h，GTView.cpp - 文档的视图
    这些文件包含 CGTView 类。
    CGTView 对象用于查看 CGTDoc 对象。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 GT.pch 的预编译头(PCH)文件和名为 StdAfx.obj 的预编译类型文件。
